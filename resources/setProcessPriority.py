...
from win32process import SetPriorityClass, BELOW_NORMAL_PRIORITY_CLASS, GetPriorityClass
from win32con import IDLE_PRIORITY_CLASS, NORMAL_PRIORITY_CLASS, HIGH_PRIORITY_CLASS, PROCESS_ALL_ACCESS
